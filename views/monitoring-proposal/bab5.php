...
<div class="container">
    <?php $form = ActiveForm::begin(); ?>
        <div class="hide">
            <?= $form->field($model, 'ID_BAB_5')->hiddenInput(['value' => '99999'])->label(false) ?>
            ...
            <h4 ><b>BAB V Penutup<b></h4>
                <div class="card" style="background-color: white; padding: 5%; margin: 5% 0 5% 0; border-radius: 7px 7px 7px 7px;">
                    <div style="margin-bottom:5%;">
                        <?php 
                            if($file_bab_5 != ''){
                                echo "File Bab 5 : " . Html::a($file_bab_5, ['monitoring-proposal/download', 'filename' => $file_bab_5], ['class' => 'profile-link']); 
                            }
                        ?>
                    </div>

                    <?php $hint = "Unggah pindaian penutup.</br><span style='color: red;'><i>*Format docs/pdf maks 5mb</i></span>" ?>

                    <?= $form->field($model, 'FILE_BAB_5', [
                    'template' => '
                        <div>
                            {input}
                        </div>
